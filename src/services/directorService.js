...
export const DIRECTOR_STATUS_OPTIONS = [
  ...
  { value: "READY_FOR_PROGRAM_CURRICULUM_COMMITTEE", label: "Pendiente Comité" },
  { value: "DIRECTOR_ASSIGNED", label: "Director Asignado" },
  { value: "UNDER_REVIEW_DIRECTOR", label: "En Revisión por Director" },
  { value: "PROPOSAL_APPROVED", label: "Propuesta Aprobada" },
  { value: "DEFENSE_REQUESTED_BY_PROJECT_DIRECTOR", label: "Sustentación Propuesta" },
  ...
  { value: "CANCELLATION_APPROVED_BY_COMMITTEE", label: "Cancelación Aprobada por Comité" },
...
export const getStatusBadgeClass = (status) => {
  const statusMap = {
    ...
    DIRECTOR_ASSIGNED: "info",
    UNDER_REVIEW_DIRECTOR: "warning",
    ...
    CANCELLATION_APPROVED_BY_COMMITTEE: "warning",
